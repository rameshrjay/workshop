...
public class UserResource {
	...
	public ResponseEntity<CommonApiResponse> registerUser(RegisterUserRequestDto request) {
		...
		User existingUserByPhone = userService.getUserByPhoneAndStatus(request.getPhoneNo(), UserStatus.ACTIVE.value());
		if (existingUserByPhone != null) {
			response.setResponseMessage("User with this Phone Number already registered!!!");
			response.setSuccess(false);
