...
public class CategoryController {
	...
	public ResponseEntity<CommonApiResponse> addCategorys(@RequestBody Category category) {
		return categoryResource.addCategorys(category);
	}

	/*
	 * @PostMapping("/add")
	 * 
	 * @Operation(summary = "Api to add category") public
	 * ResponseEntity<CommonApiResponse> addCategory(@RequestBody Category category)
