...
const UserRegister = () => {
  ...
  const clearForm = () => {
    setUser({
      ...
      city: "",
      pincode: "",
      role: user.role, // Keep the role value unchanged
    });
      ...
      .then((result) => {
        ...
        result.json().then((res) => {
          if (res.success) {
            ...
            setError(res.responseMessage); // Setting the error message
          }
        });
      })
      .catch((error) => {
      ...
      <div className="mt-2 d-flex aligns-items-center justify-content-center ms-2 me-2 mb-2">
        ...
        >
          <div className="container-fluid">
            ...
            >
              <h5 className="card-title">{user.role && user.role} Register </h5>
            </div>
